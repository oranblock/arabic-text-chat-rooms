...
4. **بوت مسابقات ذكي تفاعلي ("مسابقات الكلمات المبعثرة 🎮")** يطرح أسئلة وألغاز وترتيب حروف تراثية عراقية ويكافئ الفائزين بالنقاط آلياً.
...
| **نظام الغرف المتعددة (5 Default Rooms)** | دعم 5 غرف افتراضية دائمة: (ديوانية العراق، ألعاب ومسابقات الكلمات المبعثرة، شباب وبنات، شات بغداد، تعارف ولقاء الأحبة) مع استقلالية رسائل ومتصلي كل غرفة. | مكتمل ✅ |
...
### 🔹 ثالثاً: بوت المسابقات العراقي التفاعلي ("مسابقات الكلمات المبعثرة 🎮")

| الميزة | التفاصيل التقنية | حالة الميزة |
|---|---|---|
| **الهوية والشخصية** | بوت "مسابقات الكلمات المبعثرة 🎮" التفاعلي، يظهر برتبة `BOT` ولون سماوي مميز في قائمة المتصلين والغرف. | مكتمل ✅ |
| **بنك الأسئلة والألغاز** | مجهز بـ 12 لغزاً وسؤالاً تراثياً عراقياً وترتيب الحروف المبعثرة (بغداد، أربيل، دجلة، الفرات، دولمة، مزكوف، إلخ). | مكتمل ✅ |
